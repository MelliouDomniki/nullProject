...
public class DbSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //HOSPITALS
        Hospital h1 = new Hospital("123", "AXEPA", "Mpotsari 23", "2310874534", "Thess", "GR", 32, "axepa@gmail.com", "axepa", "axepa@", "user" );
        Hospital h2 = new Hospital("124", "IPPOKRATIO", "Mpotsari 24", "2310654534", "Thess", "GR", 67, "ippokratio@gmail.com", "ippokratio","ippokratio@", "user" );
